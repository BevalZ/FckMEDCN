...
export const UNDERGRAD_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    stage: 'undergrad',
    title: '升学路线预案',
    body: '大四上。辅导员让大家提交去向摸底：推免、考研、规培、就业。此时还没人真正上岸，保研要等公示，考研要等报名、初试、复试和调剂。',
    category: 'career',
    weight: 75,
    minTurn: 12,
    maxTurn: 15,
    ...
    choices: [
      {
        text: '先冲推免，等学院排名公示', delta: { reputation: 4, stamina: -8, knowledge: 2 }, flagSet: 'ug_baoyan_intent',
        requireStat: { knowledge: [90, 100] },
        nextEventId: 'ug_baoyan_race',
        consequence: '你把绩点、综测、科研加分和竞赛材料逐项核对。真正决定命运的是公示名单。',
      },
      { text: '备战考研，等报名窗口', delta: { knowledge: 5, stamina: -10, sanity: -4 }, flagSet: 'ug_kaoyan_intent', nextEventId: 'ug_real_kaoyan_plan', consequence: '自习室成了你的第二个家，但真正考试还在大五。' },
  ...
  // ==========================================================
  {
    ...
    category: 'career', weight: 65, minTurn: 12, maxTurn: 15, once: true,
    excludeFlag: 'baoyan',
    choices: [
      {
        text: '死磕最后一学期，把分刷回来',
      ...
      {
        text: '接受结果，转去考研',
        delta: { sanity: 4, knowledge: 3 }, flagSet: 'ug_kaoyan_intent',
        nextEventId: 'ug_real_kaoyan_plan', consequence: '你把保研的事翻篇了，第二天开始查招生目录和院线。',
      },
    ],
  },
  {
    ...
    choices: [
      ...
      {
        text: '还是差了一个位置', delta: { sanity: -10, knowledge: 3 }, flagSet: 'ug_kaoyan_intent',
        nextEventId: 'ug_real_kaoyan_plan',
        consequence: '你在楼道里站了很久，然后打开研招网查报名要求。',
      },
    ],
  },
  {
