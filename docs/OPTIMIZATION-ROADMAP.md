...
| P1 | 诉讼按亚专科/职级缩放 + 证据反哺 | 5/9 | 让已建诉讼系统有深度与交叉 | ⬜ 部分（rankScaled 已用，亚专科纠纷变体待做） |
| P1 | 晋升失败分支 + 年限门槛 + 职业期延长 | 3 | 核心职业体验"熬" | ⬜ 待做 |
| P1 | 职业暴露 / 医保飞检 | 6 | 真实高频且教育价值高 | ✅ 已落地（针刺伤/飞检事件链） |
| P1 | 资产提现 + 属性成长 | 4/9 | 让现有系统闭环 | ⬜ 待做 |
| P2 | 一作之争 / 临床型晋升 | 7 | 呼应破五唯 | ⬜ 待做 |
| P2 | 值班错过家庭 / 子女叙事 | 8 | 共鸣向粘性 | ⬜ 待做 |
| P2 | 极端组合 balance 断言 / 强制事件回归 | 9/10 | 测试防线 | ⬜ 待做 |
