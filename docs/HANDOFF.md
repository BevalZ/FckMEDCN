...
**薄 SEO / 分享卡**：`index.html` description + Open Graph/Twitter；`public/og-share.svg`。
...
- **玩法深度（Phase 2）**：医院路线职业事件池已按三甲/基层/私立/省属+编制/合同制门控接入
  ...
  妇产科轻累积：体/心双轨半速（每 2 季 +1），内科仍无累积。
  路线图回勾：Round 5 诉讼长尾、Round 6 暴露/飞检与急诊已与代码对齐（2026-08-13）。
  可玩性文档回勾：R15/R16（HUD/账单/ESC·Q/E）、R18 路线池、R20 编制/公积金（2026-08-13）。
