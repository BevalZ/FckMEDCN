...
Generated at: 2026-08-13T09:54:02.896Z
Source HEAD at generation: 08f4820
...
| scenario id | check | status | notes |
|---|---|---|---|
| new-game | 新开局 | pending | — |
| continue-save | 继续旧档 | pending | — |
| clinical-route | 完整临床线 | pending | — |
| research-route | 完整科研线 | pending | — |
| exit-route | 退出线提前终止 | pending | — |
| late-life-route | 晚年三阶段 | pending | — |
| restart-save | 重开档并确认状态重置 | pending | — |
| console-clean | 生产包控制台无错误 | pending | — |

### iOS Safari 真机：竖横屏、安全区、触控、长时操作和音频解锁

| scenario id | check | status | notes |
|---|---|---|---|
| portrait | 竖屏布局 | pending | — |
| landscape | 横屏布局 | pending | — |
| safe-area | 刘海与安全区 | pending | — |
| touch-minigames | 触控小游戏 | pending | — |
| long-session | 长时间操作与多次切场景 | pending | — |
| audio-unlock | 首次用户手势解锁音频 | pending | — |
| console-clean | 生产包控制台无错误 | pending | — |
